...
public class ConnectionAttributes {
	 ...
	 */
	public static ConnectionAttributes fromDestination(InputStream destinationJson) throws JSONException {
	...
	private static boolean isValidAuthorization(String tokenType) {
		return tokenType.equals(Constants.BASIC_WITH_TRAILING_SPACE.trim()) || tokenType.equals(Constants.BEARER_WITH_TRAILING_SPACE.trim());
	}
